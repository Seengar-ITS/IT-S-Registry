...
export default function My-packages() {
  ...
  useEffect(() => {
    if (!user) return
    supabase.from('packages').select('*').limit(20)
    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <header className="border-b border-gray-800 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-white text-sm">IT-S-Registry</h1>
            <p className="text-xs text-gray-500">My-packages</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
